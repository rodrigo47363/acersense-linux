 ...
 *
 * Disassembly of SSDT_Compal_CompCMFC_0x111758C.aml
 *
...
DefinitionBlock ("", "SSDT", 2, "Compal", "CompCMFC", 0x00003000)
{
    ...
    External (_SB_.PCI0.LPCB.EC0_.BTY0, FieldUnitObj)
            ...
            Switch (FUNN)
            {
                ...
                Case (0x26)
                {
                    ...
                    Switch (ToInteger (Arg1))
                    {
                        Case (One)
                        {
                            BFDT = ((\_SB.PCI0.LPCB.EC0.ADPT << 0x08) | \_SB.PCI0.LPCB.EC0.BOL0)
                        }
                        Case (0x02)
                        {
                            If ((INDA == One))
                            {
                                BFDT = ((\_SB.PCI0.LPCB.EC0.BAM0 << One) | \_SB.PCI0.LPCB.EC0.BTY0)
                            }
                            ElseIf ((INDA == 0x02)){}
                        }
                        Case (0x03)
